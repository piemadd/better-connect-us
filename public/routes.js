...
const routeData = {
  ...
  texasTriangleSanAntonioHouston: {
    routeName: 'Texas Triangle (San Antonio - Houston)',
    routeID: 'texasTriangleSanAntonioHouston',
    region: 'central',
    mileage: 210,
    mainStations: ['San Antonio, TX', 'Houston, TX'],
    segments: [],
    hosts: ['UP'],
    stops: {
      all: {
